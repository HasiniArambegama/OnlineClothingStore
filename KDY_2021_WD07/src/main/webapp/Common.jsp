...
<head>
	...
	<link href="css/images/DeliImage.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body>
	...
	<tbody>
		<div class="logo-404">
			<a href="index.html"><img src="images/404/Delivery.jpg" alt="" /></a>
		</div>
		...
		<div class="btn-table">
			<form action="com" method="post">
				 <input type="submit" name="view" value="Common View">
			</form></div></td>
			<td></td>
			<td></td>
		<td> 
		...
		<form action="view" method="post"> 
				 <input type="submit" name="view" value="View Current Assignments">
			</form></div></td>
			<td></td>
			<td></td>
		<td> 
		<div class="btn-table">
		<form action="delire" method="post"> 
				 <input type="submit" name="view" value="Generate Monthly Delivery Report">
			</form></div></td>
		</tr>
		</tbody>
	</table>
