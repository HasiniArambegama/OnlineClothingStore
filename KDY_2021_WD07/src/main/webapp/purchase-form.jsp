	        ...
	        <table  cellpadding="5">
               ...
               <tr> <th  class="tble-border data-align tble-h" colspan="2" >Product ID: </th>
                <td class="tble-border data-align tble-b" colspan="2">
                	<input type="text" name="name" size="40" value="<c:out value='${user1.productid}' />"/>		
                </td></tr>
            
            
                <tr><th class="tble-border data-align tble-h" colspan="2" >Supplier ID: </th>
                <td class="tble-border data-align tble-b" colspan="2">
                	<input type="text" name="con" size="40"	value="<c:out value='${user1.suppid}' />"/>
                </td></tr>
            
            
                <tr><th class="tble-border data-align tble-h" colspan="2" >Date: </th>
                <td class="tble-border data-align tble-b" colspan="2">
                	<input type="date" name="mail" size="40" value="<c:out value='${user1.date}' />"/>
                ...
                <td class="tble-border data-align tble-b" colspan="2">
                	<input type="text" name="add1" size="40" value="<c:out value='${user1.quantity}' />"/>
                </td></tr>
            
            
                <tr><th class="tble-border data-align tble-h" colspan="2" >Unit Price: </th>
                <td class="tble-border data-align tble-b" colspan="2">
                	<input type="text" name="add2" size="40" value="<c:out value='${user1.unitprice}' />"/>
                </td></tr>
                
               
            
            
            	<tr><td colspan="2" align="left"> <input type="submit" value="place order" /> </td></tr>
