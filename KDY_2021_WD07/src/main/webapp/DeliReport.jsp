...
<body>
	...
	<center><button onclick="generatePDF()">Download As PDF</button></center>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="report">
						<center><h4> Monthly Delivery Report</h4>
							<img src="images/404/delireport.jpg"/>
						</center>
						<br>
						<table class="table" background="images/404/rpt_background1.png">
					   ...
					   <c:forEach var="deliR" items="${deliInfo}">
					    
					      <tr>
					      	<td >${deliR.getCustomerId()}</td>
							<td >${deliR.getOrderId()}</td>
							<td >${deliR.getOrderDate()}</td>
							<td >${deliR.getAddress()}</td>
							<td >${deliR.getDelDate()}</td>
							<td >${deliR.getDelStatus()}</td>
							<td >${deliR.getDelPerson()}</td>	
						</tr>
					 	...
					 	<br>
					 	<center><h4>Number of Days Taken To Deliver Each Order</h4></center>
					 	<center>
					 	<table class="tble-width tble-border" background="images/404/rpt_background1.png">
					   ...
					   <c:forEach var="gap" items="${deliGap}">
					    
					      <tr>
					      	<td >${gap.getOrderID()}</td>
							<td >${gap.getAssignDP()}</td>
							<td >${gap.getNoDays()}</td>
						</tr>
